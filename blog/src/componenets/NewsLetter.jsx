...
function NewsLetter() {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <p className='md:text-lg text-gray-500/70 pb-8'>Subscribe to get the latets blog, new tech and exclusive news</p>
        <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
            ...
            hover:bg-primary transition-all cursor-pointer rounded-1-none'>Subscribe</button>
        </form>
    </div>
  )
}
